...
module admin::suisurvey{
    ...
    public struct Form has key{
        ...
        responses: Table<u64, String>, // <participant_id (vector index), blob_id>
    ...
    entry fun create_survey(
        ...
        min_participants: u64,
        max_participants: u64,
        blob_id: String, // empty form data 
        //criterias, if applicable
        contract_interaction: address, //0x0 if N/A
        reward: u64, //per participant, in sui. 0 if N/A
        state: &mut State,
    ...
    public fun get_participants_vector(
        form: &Form,
        ctx: &mut TxContext
    ): vector<address>{
        form.participants
